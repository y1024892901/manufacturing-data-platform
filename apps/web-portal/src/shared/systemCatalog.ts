...
export const systems: SystemEntry[] = [
  { code:'mdm', name:'统一主数据管理', shortName:'MDM', route:'/mdm/dashboard', accent:'#2563eb', description:'客户、供应商、物料、产品、BOM与工艺主数据的唯一权威入口', capabilities:['主数据治理','审批发布','分发对账'], menus:[{label:'系统首页',route:'/mdm/dashboard'},{label:'客户与联系人',route:'/mdm/customers'},{label:'供应商与联系人',route:'/mdm/suppliers'},{label:'物料主数据',route:'/mdm/materials'},{label:'产品主数据',route:'/mdm/products'},{label:'BOM版本',route:'/mdm/boms'},{label:'工艺路线',route:'/mdm/routings'},{label:'仓库主数据',route:'/mdm/warehouses'},{label:'工作中心',route:'/mdm/work-centers'},{label:'生产版本',route:'/mdm/production-versions'},{label:'主数据治理',route:'/mdm/governance'}] },
  { code:'crm', name:'客户关系管理', shortName:'CRM', route:'/crm/dashboard', accent:'#7c3aed', description:'管理线索、商机、报价、合同、销售预测和客户协同', capabilities:['客户360','商机漏斗','报价合同'], menus:[{label:'系统首页',route:'/crm/dashboard'},{label:'客户360',route:'/crm/customers'},{label:'销售线索',route:'/crm/leads'},{label:'商机管理',route:'/crm/opportunities'},{label:'报价管理',route:'/crm/quotations'},{label:'合同管理',route:'/crm/contracts'},{label:'销售预测',route:'/crm/forecast'},{label:'客诉协同',route:'/crm/complaints'}] },
  { code:'erp', name:'企业资源计划', shortName:'ERP', route:'/erp/dashboard', accent:'#0f766e', description:'承接销售需求，完成计划、订单、财务与经营核算', capabilities:['销售订单','生产计划','财务核算'], menus:[{label:'系统首页',route:'/erp/dashboard'},{label:'销售订单',route:'/erp/sales-orders'},{label:'信用管理',route:'/erp/credits'},{label:'交期承诺',route:'/erp/atp'},{label:'物料需求计划',route:'/erp/mrp'},{label:'计划建议',route:'/erp/suggestions'},{label:'生产订单',route:'/erp/production-orders'},{label:'应收账款',route:'/erp/receivables'},{label:'销售发票',route:'/erp/invoices'},{label:'回款核销',route:'/erp/receipts'},{label:'应付账款',route:'/erp/payables'},{label:'财务凭证',route:'/erp/vouchers'},{label:'成本毛利',route:'/erp/margins'}] },
  { code:'plm', name:'产品生命周期管理', shortName:'PLM', route:'/plm/dashboard', accent:'#0369a1', description:'管理产品结构、工艺规划、工程变更和受控文档', capabilities:['产品结构','工程变更','文档版本'], menus:[{label:'系统首页',route:'/plm/dashboard'},{label:'产品族',route:'/plm/families'},{label:'产品版本',route:'/plm/products'},{label:'EBOM / MBOM',route:'/plm/boms'},{label:'工程基线',route:'/plm/baselines'},{label:'工程变更',route:'/plm/ecns'},{label:'受控文档',route:'/plm/documents'}] },
